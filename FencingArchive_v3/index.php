...
/**
 * Step 1a: Load additional classes
 */
...
// Twig
require_once 'assets/twig/Twig-1.15.1/lib/Twig/Autoloader.php';
Twig_Autoloader::register();
$loader = new Twig_Loader_Filesystem('/home/fencingarchive.net/v3_html/assets/templates');
$twig = new Twig_Environment($loader, array('cache' => '/home/fencingarchive.net/v3_html/assets/templates/cache'));
...
$app->get('/', function () {
  global $twig;
  $utils = new Utils();
  echo $twig->render('home.html', array('url' => $utils->getCurrentUrl()));
});
...
$app->get('/fencer/:id', function ($id) {
  global $twig;
  echo $twig->render('fencer.html', array('id' => $id));
});

$app->get('/competition/:id', function ($id) {
  global $twig;
  echo $twig->render('competition.html', array('id' => $id));
});

$app->get('/club/:id', function ($id) {
  global $twig;
  echo $twig->render('club.html', array('id' => $id));
});
